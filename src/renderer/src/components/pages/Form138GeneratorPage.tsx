...
function Form138GeneratorPage(): React.JSX.Element {
  ...
  return (
    <div className="panel active" id="panel-f138">
      <div className="section-header">
        <div className="section-title">
          <h2>Form 138 – Report Card</h2>
          <p>End-of-year report card with semestral grades</p>
        </div>
      ...
      {selectedStudentId === '' ? (
        <div className="info-box">
          Select a student above to generate their Form 138 (Report Card).
        </div>
      ) : (
        selectedStudent && (
          <div className="form-preview">
            <div className="form-header-ph">
              ...
              <div className="form-name">FORM 138 – Report Card</div>
            </div>
            <div className="form-body">
              ...
              <div className="form-section-title">SEMESTRAL GRADES</div>
              <div
                style={{
                  fontFamily: 'Arial',
                  fontSize: '9px',
              ...
              >
                Report card with semestral grades will be displayed here.
              </div>
            </div>
          </div>
        )
...
export default Form138GeneratorPage
